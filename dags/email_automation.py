...
def init_email():
    sender = "gaurav.srivastav@knoldus.com" # add the sender gmail address here
    recipients = ["email address 1", "email address 2"] # add your e-mail recipients here
    subject = "Testing Email with Apache Airflow" # add the subject of the e-mail you'd like here
    send_email_basic(sender, recipients, subject)

default_args = {
    'owner': 'airflow',
    'depends_on_past': False,
    'start_date': '20-03-2021',
    'email': ['gaurav.srivastav@knoldus.com'],
